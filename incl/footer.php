					...
					<div class="row">
						<div class="col-12 col-xl-4">
							<div class="site-footer__widget footer-contacts">
								...
								<div class="footer-contacts__text">We're still under construction...</div>
								<address class="footer-contacts__contacts">
									<dl>
										<dt>Phone Number</dt>
										<dd>+234 912 0607 130</dd>
									</dl>
									<dl>
										<dt>Email Address</dt>
										<dd>fsp@fsp.com</dd>
				...
				<div class="container">
					<div class="site-footer__bottom-row">
						<div class="site-footer__copyright">
							<!-- copyright -->
							Powered by <a href="#" target="_blank">Hugh Concepts Inc.</a>
							<!-- copyright / end -->
						</div>
				...
				<div class="mobile-menu__panel-body">
						...
						<div class="mobile-menu__setting" data-mobile-menu-item="">
							<button class="mobile-menu__setting-button" title="Language" data-mobile-menu-trigger="">
								<span class="mobile-menu__setting-icon">
									<img src="images/flags/ng.png" alt="">
								</span><span class="mobile-menu__setting-title">Naira</span> <span class="mobile-menu__setting-arrow"><svg width="6px" height="9px">
					...
					<div class="mobile-menu__indicators">
						...
						<a class="mobile-menu__indicator" href="cart">
							...
							</span><span class="mobile-menu__indicator-title">Cart</span> 
						</a>
					...
					<ul class="mobile-menu__links">
						...
						<li data-mobile-menu-item="">
							<a href="shop-grid-4-columns-sidebar" class="" data-mobile-menu-trigger="">Car Brands 
							...
							<div class="mobile-menu__links-panel" data-mobile-menu-panel="">
								<div class="mobile-menu__panel mobile-menu__panel--hidden">
									...
									<div class="mobile-menu__panel-body">
										<ul class="mobile-menu__links">
											<li  data-mobile-menu-item=""><a href="shop-list" class="menu__link">ACURA</a></li>
											<li  data-mobile-menu-item=""><a href="shop-table" class="menu__link">AIXAM</a></li>
											<li  data-mobile-menu-item=""><a href="shop-right-sidebar" class="menu__link">ALFA ROMEO</a></li>
											<li  data-mobile-menu-item=""><a href="cart" class="menu__link">ALPINA</a></li>
											<li  data-mobile-menu-item=""><a href="checkout" class="menu__link">ALPINE</a></li>
											<li  data-mobile-menu-item=""><a href="order-success" class="menu__link">ALVIS</a></li>
											<li  data-mobile-menu-item=""><a href="wishlist" class="menu__link">ARO</a></li>
											<li  data-mobile-menu-item=""><a href="compare" class="menu__link">ARTEGA</a></li>
											<li  data-mobile-menu-item=""><a href="track-order" class="menu__link">ASIA MOTORS</a></li>
											<li  data-mobile-menu-item=""><a href="track-order" class="menu__link">ASKAM (FARGO/DESOTO)</a></li>
											<li  data-mobile-menu-item=""><a href="track-order" class="menu__link">ASTON MARTIN</a></li>
											<li  data-mobile-menu-item=""><a href="track-order" class="menu__link">AUDI</a></li>
											<li  data-mobile-menu-item=""><a href="track-order" class="menu__link">AUSTIN</a></li>
											<li  data-mobile-menu-item=""><a href="track-order" class="menu__link">AUSTIN-HEALEY</a></li>
											<li  data-mobile-menu-item=""><a href="track-order" class="menu__link">AUTO UNION</a></li>
											<li  data-mobile-menu-item=""><a href="track-order" class="menu__link">AUTOBIANCHI</a></li>
											<li  data-mobile-menu-item=""><a href="track-order" class="menu__link">AUVERLAND</a></li>
											<li  data-mobile-menu-item=""><a href="track-order" class="menu__link">BARKAS</a></li>					
										</ul>
									</div>
								</div>
							</div>
						...
						<li data-mobile-menu-item="">
							<a href="shop-grid-4-columns-sidebar" class="" data-mobile-menu-trigger="">Car Parts 
								<svg width="7" height="11">
									<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
									C-0.1,9.8-0.1,10.4,0.3,10.7z"></path>
								</svg></a>
							<div class="mobile-menu__links-panel" data-mobile-menu-panel="">
								<div class="mobile-menu__panel mobile-menu__panel--hidden">
									<div class="mobile-menu__panel-header">
										...
										<div class="mobile-menu__panel-title">Car Parts</div>
									</div>
									<div class="mobile-menu__panel-body">
										<ul class="mobile-menu__links">
											<li data-mobile-menu-item="">
												<a href="category" class="" data-mobile-menu-trigger="">Category 
													<svg width="7" height="11">
														<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
															C-0.1,9.8-0.1,10.4,0.3,10.7z"></path>
													</svg>
												...
												<div class="mobile-menu__links-panel" data-mobile-menu-panel="">
													<div class="mobile-menu__panel mobile-menu__panel--hidden">
														...
														<div class="mobile-menu__panel-body">
															<ul class="mobile-menu__links">
																<li data-mobile-menu-item="">
																	<a href="category-3-columns-sidebar.html" class="" data-mobile-menu-trigger="">3 Columns
																		Sidebar
																	</a>
																</li>
															</ul>
											...
											<li data-mobile-menu-item=""><a href="shop-list" class="" data-mobile-menu-trigger="">Shop List</a></li>
											
											<li data-mobile-menu-item=""><a href="cart" class="" data-mobile-menu-trigger="">Cart</a></li>
											<li data-mobile-menu-item=""><a href="checkout" class="" data-mobile-menu-trigger="">Checkout</a></li>
											<li data-mobile-menu-item=""><a href="order-success" class="" data-mobile-menu-trigger="">Order Success</a></li>
											<li data-mobile-menu-item=""><a href="wishlist" class="" data-mobile-menu-trigger="">Wishlist</a></li>
											<li data-mobile-menu-item=""><a href="compare" class="" data-mobile-menu-trigger="">Compare</a></li>
											<li data-mobile-menu-item=""><a href="track-order" class="" data-mobile-menu-trigger="">Track Order</a></li>
										</ul>
									</div>
								</div>
							</div>
						...
						<li data-mobile-menu-item="">
							<a href="login" class="" data-mobile-menu-trigger="">Account 
								<svg width="7" height="11">
									<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
							...
							<div class="mobile-menu__links-panel" data-mobile-menu-panel="">
								<div class="mobile-menu__panel mobile-menu__panel--hidden">
									...
									<div class="mobile-menu__panel-body">
										<ul class="mobile-menu__links">
											<li data-mobile-menu-item=""><a href="login" class="" data-mobile-menu-trigger="">Login & Register</a></li>
											<?php if(isset($_SESSION['fran_username_sess'])):?>
											<li data-mobile-menu-item=""><a href="dashboard/dashboard" class="" data-mobile-menu-trigger="">Dashboard</a></li>
											<li data-mobile-menu-item=""><a href="dashboard/garage" class="" data-mobile-menu-trigger="">Garage</a></li>
											<li data-mobile-menu-item=""><a href="dashboard/profile" class="" data-mobile-menu-trigger="">Edit Profile</a></li>
											<li data-mobile-menu-item=""><a href="dashboard/orders" class="" data-mobile-menu-trigger="">Order History</a></li>
											<li data-mobile-menu-item=""><a href="dashboard/order-details" class="" data-mobile-menu-trigger="">Order Details</a></li>
											<li data-mobile-menu-item=""><a href="dashboard/addresses" class="" data-mobile-menu-trigger="">Address Book</a></li>
											<li data-mobile-menu-item=""><a href="dashboard/edit-address" class="" data-mobile-menu-trigger="">Edit Address</a></li>
											<li data-mobile-menu-item=""><a href="dashboard/password" class="" data-mobile-menu-trigger="">Change Password</a></li>
											<?php endif;?>
										</ul>
									</div>
								</div>
		...
		<div class="vehicle-picker-modal modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="vehicle-picker-modal__panel vehicle-picker-modal__panel--active" data-panel="list">
						...
						<div class="vehicles-list__body">
							<label class="vehicles-list__item">
								...
								<span class="vehicles-list__item-info">
									<span class="vehicles-list__item-name">2011 Ford Focus S
									</span> 
					...
					<div class="vehicle-picker-modal__actions"><button type="button" class="btn btn-sm btn-secondary vehicle-picker-modal__close-button">Cancel</button> <button type="button" class="btn btn-sm btn-primary" data-to-panel="form">Add A Vehicle</button>
					</div>
				</div>
