        ...
        <div class="container">
            <div class="mobile-header__body">
                ...
                <a class="mobile-header__logo" href="/">
                    <n class="text-uppercase"><h6><n class="text-dark">Franco</n><n class=" text-danger"> Spare Parts</n></h6></n>
...
<header class="site__header">
    <div class="header position-fixed col-lg-12">
        <div class="header__megamenu-area megamenu-area"></div>
        <div class="header__topbar-start-bg"></div>
        <div class="header__topbar-start">
            <div class="topbar topbar--spaceship-start">
                <div class="topbar__item-text d-none d-xxl-flex">Call Us: <a href="tel:+234 912 0607 130" class="text-white font-weight-light"> +234 912 0607 130</a></div>
            ...
            <div class="topbar topbar--spaceship-end">
                ...
                <div class="topbar__item-button topbar__menu">
                    <button class="topbar__button topbar__button--has-arrow topbar__menu-button" type="button">
                        ...
                        <span class="topbar__button-title">NGN</span>
                    ...
                    <div class="topbar__menu-body">
                        <a class="topbar__menu-item" href="#">₦ Naira</a>
                    </div>
                </div>
                <div class="topbar__menu">
					...
					<div class="topbar__menu-body">
						<a class="topbar__menu-item" href="#">
							<img src="images/flags/ng.png" alt=""><span>English</span> 
						</a>
					</div>
				</div>
            </div>
                        ...
                        <div class="departments__body">
                            <ul class="departments__list">
                                ...
                                <li class="departments__item departments__item--submenu--megamenu departments__item--has-submenu">
                                    <a href="" class="departments__item-link">Headlights & Lighting <span class="departments__item-arrow">
                                        ...
                                        <div class="row">
                                            <div class="col-1of5">
                                                <ul class="megamenu__links megamenu-links megamenu-links--root">
                                                    ...
                                                    <li class="megamenu-links__item"><a class="megamenu-links__item-link" href="">Fuel
                                                            Systems</a></li>
                                                    <li class="megamenu-links__item"><a class="megamenu-links__item-link" href="">Transmission</a></li>
                                                    <li class="megamenu-links__item"><a class="megamenu-links__item-link" href="">Air
                                                            Filters</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-1of5">
                                ...
                                <li class="departments__item departments__item--submenu--megamenu departments__item--has-submenu">
                                    <a href="" class="departments__item-link">Interior Parts <span class="departments__item-arrow">
                                        <svg width="7" height="11">
                                            <path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
							                    C-0.1,9.8-0.1,10.4,0.3,10.7z">
                                            </path>
                                ...
                                <li class="departments__item departments__item--submenu--megamenu departments__item--has-submenu">
                                    <a href="" class="departments__item-link">Switches & Relays 
                                ...
                                <li class="departments__item departments__item--submenu--megamenu departments__item--has-submenu">
                                    <a href="" class="departments__item-link">Tires & Wheels 
                                        <span class="departments__item-arrow">
                                            <svg width="7" height="11">
                                                <path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
			                                        C-0.1,9.8-0.1,10.4,0.3,10.7z">
                                ...
                                <li class="departments__item departments__item--submenu--megamenu departments__item--has-submenu">
                                    <a href="" class="departments__item-link">Tools & Garage 
                                        <span class="departments__item-arrow">
                                            <svg width="7" height="11">
                                                <path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
				                                    C-0.1,9.8-0.1,10.4,0.3,10.7z">
                ...
                <div class="main-menu">
                    <ul class="main-menu__list">
                        <li class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
                            <a href="/" class="main-menu__link"><span class="fas fa-home text-grey"></span></a>
                        </li>
                        <li class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
                            <a href="shop-grid-4-columns-sidebar.html" class="main-menu__link text-uppercase">Car Brands 
                                <svg width="7px" height="5px">
                                    <path d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z">
                                    </path>
                                </svg>
                            ...
                            <div class="main-menu__submenu">
                                <ul class="menu">
                                    <li class="menu__item menu__item--has-submenu">
                                        <a href="category-4-columns-sidebar.html" class="menu__link">ABARTH
                                    ...
                                    <li class="menu__item menu__item--has-submenu">
                                        <a href="shop-grid-4-columns-sidebar.html" class="menu__link">AC
                                            <span class="menu__arrow">
                                                <svg width="6px" height="9px">
                                                    <path d="M0.3,7.4l3-2.9l-3-2.9c-0.4-0.3-0.4-0.9,0-1.3l0,0c0.4-0.3,0.9-0.4,1.3,0L6,4.5L1.6,8.7c-0.4,0.4-0.9,0.4-1.3,0l0,0C-0.1,8.4-0.1,7.8,0.3,7.4z">
                                                    </path>
                                    ...
                                    <li class="menu__item"><a href="shop-list" class="menu__link">ACURA</a></li>
                                    <li class="menu__item"><a href="shop-table" class="menu__link">AIXAM</a></li>
                                    <li class="menu__item"><a href="shop-right-sidebar" class="menu__link">ALFA ROMEO</a></li>
                                    
                                    <li class="menu__item"><a href="cart" class="menu__link">ALPINA</a></li>
                                    <li class="menu__item"><a href="checkout" class="menu__link">ALPINE</a></li>
                                    <li class="menu__item"><a href="order-success" class="menu__link">ALVIS</a></li>
                                    <li class="menu__item"><a href="wishlist" class="menu__link">ARO</a></li>
                                    <li class="menu__item"><a href="compare" class="menu__link">ARTEGA</a></li>
                                    <li class="menu__item"><a href="track-order" class="menu__link">ASIA MOTORS</a></li>
                                    <li class="menu__item"><a href="track-order" class="menu__link">ASKAM (FARGO/DESOTO)</a></li>
                                    <li class="menu__item"><a href="track-order" class="menu__link">ASTON MARTIN</a></li>
                                    <li class="menu__item"><a href="track-order" class="menu__link">AUDI</a></li>
                                    <li class="menu__item"><a href="track-order" class="menu__link">AUSTIN</a></li>
                                    <li class="menu__item"><a href="track-order" class="menu__link">AUSTIN-HEALEY</a></li>
                                    <li class="menu__item"><a href="track-order" class="menu__link">AUTO UNION</a></li>
                                    <li class="menu__item"><a href="track-order" class="menu__link">AUTOBIANCHI</a></li>
                                    <li class="menu__item"><a href="track-order" class="menu__link">AUVERLAND</a></li>
                                    <li class="menu__item"><a href="track-order" class="menu__link">BARKAS</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
                            <a href="shop-grid-4-columns-sidebar.html" class="main-menu__link text-uppercase">Car Parts 
                                <svg width="7px" height="5px">
                                    <path d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z">
                                    </path>
                                </svg>
                            ...
                            <div class="main-menu__submenu">
                                <ul class="menu">
                                    ...
                                    <li class="menu__item menu__item--has-submenu">
                                        <a href="shop-grid-4-columns-sidebar.html" class="menu__link">Shop Grid
                                            <span class="menu__arrow">
                                                <svg width="6px" height="9px">
                                                    <path d="M0.3,7.4l3-2.9l-3-2.9c-0.4-0.3-0.4-0.9,0-1.3l0,0c0.4-0.3,0.9-0.4,1.3,0L6,4.5L1.6,8.7c-0.4,0.4-0.9,0.4-1.3,0l0,0C-0.1,8.4-0.1,7.8,0.3,7.4z">
                                                    </path>
                                    ...
                                    <li class="menu__item"><a href="order-success" class="menu__link">Order Success</a></li>
                        ...
                        <li class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
                            <a href="login" class="main-menu__link text-uppercase">Account <svg width="7px" height="5px">
                                    <path d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z">
                                    </path>
                                </svg></a>
                            <div class="main-menu__submenu">
        ...
        <div class="header__logo">
            <a href="/" class="logo">
                ...
                <div class="logo__image">
                    <center class="text-uppercase"><h3><n class="text-dark">Franco</n><n class=" text-danger"> Spare Parts</n></h3></center>
                </div>
            </a>
        </div>
        <div class="header__search">
            <div class="search">
                <form action="" class="search__body">
                    <div class="search__shadow"></div><input class="search__input" type="text" placeholder="Enter Keyword or Part Number"> <button class="search__button search__button--start" type="button"><span class="search__button-icon"><svg width="20" height="20">
                                <path d="M6.6,2c2,0,4.8,0,6.8,0c1,0,2.9,0.8,3.6,2.2C17.7,5.7,17.9,7,18.4,7C20,7,20,8,20,8v1h-1v7.5c0,0.8-0.7,1.5-1.5,1.5h-1
			c-0.8,0-1.5-0.7-1.5-1.5V16H5v0.5C5,17.3,4.3,18,3.5,18h-1C1.7,18,1,17.3,1,16.5V16V9H0V8c0,0,0.1-1,1.6-1C2.1,7,2.3,5.7,3,4.2
			C3.7,2.8,5.6,2,6.6,2z M13.3,4H6.7c-0.8,0-1.4,0-2,0.7c-0.5,0.6-0.8,1.5-1,2C3.6,7.1,3.5,7.9,3.7,8C4.5,8.4,6.1,9,10,9
			c4,0,5.4-0.6,6.3-1c0.2-0.1,0.2-0.8,0-1.2c-0.2-0.4-0.5-1.5-1-2C14.7,4,14.1,4,13.3,4z M4,10c-0.4-0.3-1.5-0.5-2,0
			...
			C15.5,10.2,14,11.3,14,12z"></path>
                    ...
                    <button class="search__button search__button--end" type="submit"><span class="search__button-icon"><svg width="20" height="20">
                                <path d="M19.2,17.8c0,0-0.2,0.5-0.5,0.8c-0.4,0.4-0.9,0.6-0.9,0.6s-0.9,0.7-2.8-1.6c-1.1-1.4-2.2-2.8-3.1-3.9C10.9,14.5,9.5,15,8,15
			c-3.9,0-7-3.1-7-7s3.1-7,7-7s7,3.1,7,7c0,1.5-0.5,2.9-1.3,4c1.1,0.8,2.5,2,4,3.1C20,16.8,19.2,17.8,19.2,17.8z M8,3C5.2,3,3,5.2,3,8
			c0,2.8,2.2,5,5,5c2.8,0,5-2.2,5-5C13,5.2,10.8,3,8,3z"></path>
                    ...
                    <div class="search__dropdown search__dropdown--suggestions suggestions">
                        ...
                        <div class="suggestions__group">
                            ...
                            <div class="suggestions__group-content"><a class="suggestions__item suggestions__category" href="">Headlights &
                                    Lighting</a> <a class="suggestions__item suggestions__category" href="">Fuel
                                    System & Filters</a> <a class="suggestions__item suggestions__category" href="">Body Parts & Mirrors</a> <a class="suggestions__item suggestions__category" href="">Interior
                                    Accessories</a></div>
                        </div>
                    </div>
                            ...
                            <div class="vehicle-picker__panel-body">
                                ...
                                <div class="vehicle-picker__actions">
                                    <div class="search__car-selector-link"><a href="" data-to-panel="list">Back
                                            to vehicles list</a></div><button type="button" class="btn btn-primary btn-sm" disabled="disabled">Add A
                                        Vehicle</button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="header__indicators">
                    ...
                    <div class="account-menu">
                        <form class="account-menu__form">
                            ...
                            <div class="form-group"><label for="header-signin-email" class="sr-only">Email
                                    address</label> <input id="header-signin-email" type="email" class="form-control form-control-sm" placeholder="Email address"></div>
                            ...
                            <div class="account-menu__form-link"><a href="signup">Create An
                                    Account</a></div>
                        </form>
                        <?php if(isset($_SESSION['fran_username_sess'])):?>
                        <div class="account-menu__divider"></div><a href="" class="account-menu__user">
                            ...
                            <div class="account-menu__user-info">
                                <div class="account-menu__user-name">Support</div>
            ...
            <div class="indicator indicator--trigger--click"><a href="cart.html" class="indicator__button"><span class="indicator__icon"><svg width="32" height="32">
			...
			c-0.6,0-1-0.4-1-1s0.4-1,1-1h15.5c0.8,0,1.5,0.4,2,1c0.5,0.6,0.6,1.5,0.4,2.2l-3.1,10C28.5,20.3,27.5,21,26.4,21z"></path>
                        </svg> <span class="indicator__counter">3</span> </span><span class="indicator__title">Shopping Cart</span> <span class="indicator__value">₦250.00</span></a>
                <div class="indicator__content">
                    <div class="dropcart">
                        <ul class="dropcart__list">
                            <li class="dropcart__item">
                                <div class="dropcart__item-image image image--type--product">
                                    <a class="image__body" href="product">
                                        <img class="image__tag" src="images/products/product-4-70x70.jpg" alt=""></a></div>
                                <div class="dropcart__item-info">
                                    <div class="dropcart__item-name"><a href="product">Glossy Gray 19"
			...
			C9.2,7.8,9.2,8.4,8.8,8.8z"></path>
                            ...
                            <li class="dropcart__item">
                                <div class="dropcart__item-image image image--type--product">
                                    <a class="image__body" href="product"><img class="image__tag" src="images/products/product-2-70x70.jpg" alt=""></a></div>
                                <div class="dropcart__item-info">
                                    <div class="dropcart__item-name"><a href="product">Brandix Brake
			...
			C9.2,7.8,9.2,8.4,8.8,8.8z"></path>
                            ...
                            <li class="dropcart__divider" role="presentation"></li>
                            <li class="dropcart__item">
                                <div class="dropcart__item-image image image--type--product"><a class="image__body" href="product"><img class="image__tag" src="images/products/product-5-70x70.jpg" alt=""></a></div>
                                <div class="dropcart__item-info">
                                    <div class="dropcart__item-name"><a href="product">Twin Exhaust
			...
			C9.2,7.8,9.2,8.4,8.8,8.8z"></path>
                        ...
                        <div class="dropcart__actions">
                            ...
                            <a href="checkout" class="btn btn-primary">Checkout</a></div>
                    </div>
                </div>
            </div>
        </div>
